...
namespace LibraryManagementSystem
{
	...
	partial class frmBookIssueRecord_Staff : System.Windows.Forms.Form
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmBookIssueRecord_Staff));
			...
			this.cmbStaffName1 = new System.Windows.Forms.ComboBox();
			...
			this.GroupBox2.Text = "By Issue Date and Staff Name";
			//
			//cmbStaffName
			//
			...
			//GroupBox3
			//
			this.GroupBox3.Controls.Add(this.cmbStaffName1);
			...
			this.GroupBox3.Text = "By Due Date and Staff Name";
			//
			//cmbStaffName1
			//
			this.cmbStaffName1.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest;
			this.cmbStaffName1.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems;
			this.cmbStaffName1.FormattingEnabled = true;
			this.cmbStaffName1.Items.AddRange(new object[] {
				"Student",
				"Staff"
			});
			this.cmbStaffName1.Location = new System.Drawing.Point(321, 38);
			this.cmbStaffName1.Name = "cmbStaffName1";
			this.cmbStaffName1.Size = new System.Drawing.Size(163, 25);
			this.cmbStaffName1.TabIndex = 35;
			//
			//Label10
			//
			...
			this.Name = "frmBookIssueRecord_Staff";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Search Issued Books Record [Staff]";
		...
		private System.Windows.Forms.ComboBox withEventsField_cmbStaffName1;
		internal System.Windows.Forms.ComboBox cmbStaffName1 {
			get { return withEventsField_cmbStaffName1; }
			set {
				if (withEventsField_cmbStaffName1 != null) {
					withEventsField_cmbStaffName1.SelectedIndexChanged -= cmbStaffName1_SelectedIndexChanged;
				}
				withEventsField_cmbStaffName1 = value;
				if (withEventsField_cmbStaffName1 != null) {
					withEventsField_cmbStaffName1.SelectedIndexChanged += cmbStaffName1_SelectedIndexChanged;
				}
			}
		...
		public frmBookIssueRecord_Staff()
		{
