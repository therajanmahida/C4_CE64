...
{
	public partial class frmBookRecord3
	{
		...
		private void dataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookIssue.cmbAccessionNo1.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtBookTitle1.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtAuthor1.Text = dr.Cells[2].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtCategory1.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtISBN1.Text = dr.Cells[7].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtEdition1.Text = dr.Cells[9].Value.ToString();
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
