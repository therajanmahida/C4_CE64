...
{
	public partial class frmBookRecord1
	{
		...
		private void cmbPOP_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT AccessionNo as [Accession No], BookTitle as [Book Title], Author, JointAuthors as [Joint Authors], Subject, Department, Barcode, ISBN, Volume, Edition, ClassNo as [Class No], Publisher, PlaceOfPublisher as [Place Of Publisher], CD,PublishingYear as [Publishing Year], Reference, NoOfBooks, AlmiraPosition as [Almira Position], Price, BillDate as [Bill Date],SupplierName,Remarks from book  where PlaceOfPublisher= '" + cmbPOP.Text + "' order by BookTitle", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "Book");
		...
		private void dataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookEntry.txtAccessionNo.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookEntry.TextBox1.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtBookTitle.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtAuthor.Text = dr.Cells[2].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtJointAuthor.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookEntry.cmbSubject.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookEntry.cmbDepartment.Text = dr.Cells[5].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtBarcode.Text = dr.Cells[6].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtISBN.Text = dr.Cells[7].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtVolume.Text = dr.Cells[8].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtEdition.Text = dr.Cells[9].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtClassNo.Text = dr.Cells[10].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtPublisherName.Text = dr.Cells[11].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtPlaceOfPublisher.Text = dr.Cells[12].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtCD.Text = dr.Cells[13].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtPublishingYear.Text = dr.Cells[14].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtReference.Text = dr.Cells[15].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtNoOfBooks.Text = dr.Cells[16].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtAlmiraPosition.Text = dr.Cells[17].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtPrice.Text = dr.Cells[18].Value.ToString();
				My.MyProject.Forms.frmBookEntry.dtpBillDate.Text = dr.Cells[19].Value.ToString();
				My.MyProject.Forms.frmBookEntry.cmbSupplierName.Text = dr.Cells[20].Value.ToString();
				My.MyProject.Forms.frmBookEntry.txtRemarks.Text = dr.Cells[21].Value.ToString();
				My.MyProject.Forms.frmBookEntry.btnUpdate_record.Enabled = true;
				My.MyProject.Forms.frmBookEntry.btnDelete.Enabled = true;
				My.MyProject.Forms.frmBookEntry.btnSave.Enabled = false;
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
