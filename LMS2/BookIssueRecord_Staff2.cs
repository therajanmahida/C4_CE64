...
{
	public partial class frmBookIssueRecord_Staff2
	{
		...
		private void DataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookReturn.txtTransactionID1.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookReturn.dtpIssueDate1.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookReturn.dtpDueDate1.Text = dr.Cells[2].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtAccessionNo1.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtBookTitle1.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtAuthor1.Text = dr.Cells[5].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtCategory1.Text = dr.Cells[6].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtISBN1.Text = dr.Cells[7].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtEdition1.Text = dr.Cells[8].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtStaffID.Text = dr.Cells[9].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtStaffName.Text = dr.Cells[10].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtDepartment1.Text = dr.Cells[12].Value.ToString();
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
		...
		public frmBookIssueRecord_Staff2()
		{
