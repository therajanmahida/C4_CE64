...
{
	public partial class frmBookIssueRecord_Staff
	{
		...
		private void DataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookIssue.txtTransactionID1.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookIssue.dtpIssueDate1.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookIssue.dtpDueDate1.Text = dr.Cells[2].Value.ToString();
				My.MyProject.Forms.frmBookIssue.cmbAccessionNo1.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookIssue.TextBox2.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtBookTitle1.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtAuthor1.Text = dr.Cells[5].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtCategory1.Text = dr.Cells[6].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtISBN1.Text = dr.Cells[7].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtEdition1.Text = dr.Cells[8].Value.ToString();
				My.MyProject.Forms.frmBookIssue.cmbStaffID.Text = dr.Cells[9].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtStaffName.Text = dr.Cells[10].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtDepartment1.Text = dr.Cells[11].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtStatus1.Text = dr.Cells[12].Value.ToString();
				My.MyProject.Forms.frmBookIssue.btnUpdate1.Enabled = true;
				My.MyProject.Forms.frmBookIssue.btnDelete1.Enabled = true;
				My.MyProject.Forms.frmBookIssue.btnSave1.Enabled = false;
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
