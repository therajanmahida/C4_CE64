...
{
	public partial class frmBookIssueRecord2
	{
		...
		private void txtBookName1_TextChanged(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department, Status from Book,BookIssue_Student,Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID and Status='Issued' and DueDate Between #" + DateTimePicker2.Text + "# and #" + DateTimePicker1.Text + "# and BookTitle like '" + txtBookName1.Text + "%' order by DueDate desc ", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "BookIssue_Student");
				myDA.Fill(myDataSet, "Book");
		...
		private void Button1_Click(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department, Status from Book,BookIssue_Student,Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID and Status='Issued' and IssueDate Between #" + DateTimePicker8.Text + "# and #" + DateTimePicker7.Text + "#  order by IssueDate desc ", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "BookIssue_Student");
				myDA.Fill(myDataSet, "Book");
		...
		private void cmbStudentName_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department, Status from Book,BookIssue_Student,Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID and Status='Issued' and IssueDate Between #" + DateTimePicker4.Text + "# and #" + DateTimePicker3.Text + "# and StudentName= '" + cmbStudentName.Text + "' order by IssueDate desc ", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "BookIssue_Student");
				myDA.Fill(myDataSet, "Book");
		...
		private void cmbStudentName1_SelectedIndexChanged(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department, Status from Book,BookIssue_Student,Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID and Status='Issued' and DueDate Between #" + DateTimePicker6.Text + "# and #" + DateTimePicker5.Text + "# and StudentName= '" + cmbStudentName1.Text + "' order by DueDate desc ", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "BookIssue_Student");
				myDA.Fill(myDataSet, "Book");
		...
		private void txtStudentName_TextChanged(System.Object sender, System.EventArgs e)
		{
			try {
				con = new OleDbConnection(cs);
				con.Open();
				cmd = new OleDbCommand("SELECT TransactionID as [Transaction ID], IssueDate as [Issue Date], DueDate as [Due Date], Book.AccessionNo as [Accession No],BookTitle as [Book Title],Author,Subject,ISBN,Edition,Student.StudentID as [Student ID],StudentName as [Student Name],Course,Student.Department, Status from Book,BookIssue_Student,Student where Book.AccessionNo=BookIssue_Student.AccessionNo and BookIssue_Student.StudentID=Student.StudentID and Status='Issued'  and StudentName like '" + txtStudentName.Text + "%' order by Studentname ", con);
				OleDbDataAdapter myDA = new OleDbDataAdapter(cmd);
				DataSet myDataSet = new DataSet();
				myDA.Fill(myDataSet, "BookIssue_Student");
				myDA.Fill(myDataSet, "Book");
		...
		private void DataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookReturn.txtTransactionID.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookReturn.dtpIssueDate.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookReturn.dtpDueDate.Text = dr.Cells[2].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtAccessionNo.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookReturn.TextBox1.Text = dr.Cells[3].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtBookTitle.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtAuthor.Text = dr.Cells[5].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtCategory.Text = dr.Cells[6].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtISBN.Text = dr.Cells[7].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtEdition.Text = dr.Cells[8].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtStudentID.Text = dr.Cells[9].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtStudentName.Text = dr.Cells[10].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtCourse.Text = dr.Cells[11].Value.ToString();
				My.MyProject.Forms.frmBookReturn.txtDepartment.Text = dr.Cells[12].Value.ToString();
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
