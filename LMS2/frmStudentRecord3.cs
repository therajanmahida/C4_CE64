...
namespace LibraryManagementSystem
{
	...
	public partial class frmStudentRecord3
	{
		...
		private void DataGridView1_RowHeaderMouseClick(object sender, System.Windows.Forms.DataGridViewCellMouseEventArgs e)
		{
			try {
				...
				My.MyProject.Forms.frmBookIssue.cmbStudentID.Text = dr.Cells[0].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtStudentName.Text = dr.Cells[1].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtCourse.Text = dr.Cells[4].Value.ToString();
				My.MyProject.Forms.frmBookIssue.txtDepartment.Text = dr.Cells[5].Value.ToString();
			} catch (Exception ex) {
				MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
